...
class DateRangeBoundryFieldController
    extends RangeBoundryFieldController<DateTime> {
...
class DateRangeFieldController
    extends RangeFieldController<DateTime, DateRangeBoundryFieldController> {
  DateRangeFieldController({
    ...
    super.forcedErrorText,
         ...
         areEqualValues: (DateTime x, DateTime y) =>
             x.year == y.year && x.month == y.month && x.day == y.day,
         minBoundryControllerBuilder: (rangeFieldController) =>
             DateRangeBoundryFieldController(
               isMin: true,
               rangeFieldController: rangeFieldController,
             ),
         maxBoundryControllerBuilder: (rangeFieldController) =>
             DateRangeBoundryFieldController(
               isMin: false,
               rangeFieldController: rangeFieldController,
             ),

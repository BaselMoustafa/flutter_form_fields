...
class IntStringRangeBoundryFieldController
    extends ConvertableRangeBoundryFieldController<int, String> {
...
class IntStringRangeFieldController
  ...
  IntStringRangeFieldController({
    ...
    super.forcedErrorText,
         ...
         minBoundryControllerBuilder: (rangeController) =>
             IntStringRangeBoundryFieldController(
               isMin: true,
               rangeFieldController: rangeController,
             ),
         maxBoundryControllerBuilder: (rangeController) =>
             IntStringRangeBoundryFieldController(
               isMin: false,
               rangeFieldController: rangeController,
             ),
